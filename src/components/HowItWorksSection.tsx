...
const TimelineConnector: React.FC<{ progress: number }> = ({ progress }) => (
  <div className="hidden md:block absolute top-12 left-0 w-full h-0.5">
    <div className="relative w-full h-full bg-gray-200 rounded">
      <motion.div 
        className="absolute left-0 top-0 h-full bg-[#D4AF37] rounded"
...
export default function HowItWorksSection() {
  ...
  return (
    <section className="py-16 md:py-20 bg-[#FFCEB5]/10" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-4">How Cannè Works</h2>
          ...
          >
            {steps.map((step) => (
              <motion.div
                ...
                className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300 relative"
              >
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-3 bg-[#1A1A1A] hover:bg-black text-white font-medium rounded-lg transition-colors duration-200 inline-flex items-center gap-2"
          >
            Browse Tiers
