...
export default function UltraPage() {
  ...
  const tierInfo = {
    ...
    details: [
      'Eight premium high-resolution digital artworks',
      'Exclusive gallery-quality collection',
      'Artist-signed digital certificate',
      'Limited edition numbering',
      'VIP digital art collector status',
      'Premium print ready 24"x36" digital files',
      'Complimentary 28g premium flower gift collection'
    ],
    bgColor: 'from-purple-500 to-indigo-700',
    colorTheme: 'Purple/Indigo',
    imageUrl: '/images/products/ultra.jpg'
  };
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className={`aspect-square bg-gradient-to-br ${tierInfo.bgColor} relative`}>
              ...
              {/* Premium badge */}
              <div className="absolute top-4 left-4 px-3 py-1 bg-gradient-to-r from-amber-400 to-amber-600 text-white text-sm font-bold rounded-full shadow-lg">
                Premium
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 lg:p-10 flex flex-col">
              ...
              <div className="mt-auto pt-6 border-t border-gray-100">
                <button 
                  ...
                  className={`w-full ${itemInCart ? 'bg-green-500 hover:bg-green-600' : 'bg-gradient-to-r from-purple-500 to-indigo-600'} text-white font-medium py-4 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2`}
