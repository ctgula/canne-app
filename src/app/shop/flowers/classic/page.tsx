...
export default function ClassicPage() {
  ...
  const tierInfo = {
    ...
    details: [
      'Two high-resolution digital artworks',
      'Digital artist signature',
      'Certificate of authenticity',
      'Print ready 12"x16" digital files',
      'Complimentary 7g flower gift'
    ],
    bgColor: 'from-violet-400 to-violet-600',
    colorTheme: 'Violet',
    imageUrl: '/images/products/classic.jpg'
  };
            ...
            <div className="p-6 md:p-8 lg:p-10 flex flex-col">
              ...
              <div className="mt-auto pt-6 border-t border-gray-100">
                <button 
                  ...
                  className={`w-full ${itemInCart ? 'bg-green-500 hover:bg-green-600' : 'bg-gradient-to-r from-violet-500 to-purple-600'} text-white font-medium py-4 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2`}
