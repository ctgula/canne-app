                ...
                <div className="flex space-x-2">
                  <div className="relative flex-1">
                    <button
                      ...
                      className="w-full bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors flex items-center justify-center gap-1"
                    >
                      Change Status
